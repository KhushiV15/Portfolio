...
export function NetflixProjectsSection() {
  ...
  const projects = [
    ...
    {
      title: "Stat.Pop",
      description: "Designed and developed an interactive statistics dashboard to dynamically visualize and filter dataset insights, improving user experience and performance.",
      image: "/data.svg",
      tags: ["Next.js", "TypeScript", "React", "Tailwind CSS"],
      githubUrl: "https://github.com/KhushiV15/Stat.Pop",
      liveUrl: "https://stat-pop.vercel.app/",
      featured: true
    },
